...
def test_flags_employer_abbreviations():
    df = _df(
        [["INDIVIDUAL", "EMA INV MGMT"], ["INDIVIDUAL", "KIMBER MFG"],
         ["INDIVIDUAL", "GOLDMAN SACHS"], ["INDIVIDUAL", "RETIRED"]],
...
def test_near_duplicates_collapse_abbrev_but_split_different_firms():
    df = _df(
        [["INDIVIDUAL", "ROBICO MANAGEMENT"], ["INDIVIDUAL", "ROBICO MGMT"],
         ["INDIVIDUAL", "M&R MANAGEMENT"], ["INDIVIDUAL", "S&A MANAGEMENT"]],
        ["entity_type", "contributor_employer"],
    )
